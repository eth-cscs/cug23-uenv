...
\begin{figure*}[htp!]
    ...
    \end{center}
    \caption{OSU point-to-point bandwidth benchmark for device-device (top) and host-host (bottom) transfers using cray-mpich installed as part of a spack stack (uenv) and CPE.}
    \label{fig:osu}
\end{figure*}

...
\begin{figure}[htp!]
    \begin{center}
        \input{images/osu-p2p-gpu.tex}
        \input{images/osu-p2p-cpu.tex}
    \end{center}
    \caption{OSU point-to-pint bandwidth benchmark for device-device (top) and host-host (bottom) transfers using cray-mpich installed as part of a spack stack (uenv) and CPE.}
    \label{fig:osu-p2p-bw}
\end{figure}

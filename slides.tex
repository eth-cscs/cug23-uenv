...
\begin{frame}[fragile]{MPI Future Plans}
    ...
    \begin{itemize}
        ...
        \item Support for aarch64 for 
    \end{itemize}
    We 

    \vspace{10pt}

    At the same time we are collaborating with HPE to get access to nightly builds of these components to integrate into our CI/CD pipelines.
    \begin{itemize}

\begin{tikzpicture}[scale=0.8]
    \begin{axis} [
        ...
        \addplot[fill=green!60] table[x=num_tasks, y=it_throughput_per_min] {./data/sphexa/tbl/run-report-MI200-64M-CPE-cpe2212.tbl};
        \addlegendentry{cpe/22.12}

        \addplot[fill=orange!60] table[x=num_tasks, y=it_throughput_per_min] {./data/sphexa/tbl/run-report-MI200-64M-SQFS-cpe2212.tbl};

    \begin{tikzpicture}[scale=1]
        \begin{loglogaxis} [
            ...
            \addplot[color=green!70!black,mark=*,thick] table[x=bytes, y=cpe-cpu-bw] {./data/osu/p2p.tbl};
            \addlegendentry{cpe/cpu}
            \addplot[color=orange,mark=x,very thick] table[x=bytes, y=sq-cpu-bw] {./data/osu/p2p.tbl};

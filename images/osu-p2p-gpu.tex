    \begin{tikzpicture}[scale=1]
        \begin{loglogaxis} [
            ...
            \addplot[color=green!70!black,mark=*, very thick] table[x=bytes, y=cpe-gpu-bw] {./data/osu/p2p.tbl};
            \addlegendentry{cpe/gpu}
            \addplot[color=orange,mark=x, very thick] table[x=bytes, y=sq-gpu-bw] {./data/osu/p2p.tbl};

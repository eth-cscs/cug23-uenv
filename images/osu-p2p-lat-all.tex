    \begin{tikzpicture}[scale=1]
        \begin{loglogaxis} [
            ...
            \addplot[color=green!40!black, very thick, densely dotted, forget plot, opacity=0.5]
                table[x=bytes, y=cpe-cpu-lat] {./data/osu/p2p.tbl};
            \addplot[color=orange!90!black, very thick, densely dotted, forget plot, opacity=0.5]
                table[x=bytes, y=sq-cpu-lat] {./data/osu/p2p.tbl};

            \addplot[color=green!40!black, very thick, forget plot, opacity=0.5]
                table[x=bytes, y=cpe-gpu-lat] {./data/osu/p2p.tbl};
            \addplot[color=orange!90!black, very thick, forget plot, opacity=0.5]
